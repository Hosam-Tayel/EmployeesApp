...
namespace EmployeesApp.Migrations
{
    ...
    [Migration("20240219211256_insertData2")]
            ...
            modelBuilder.Entity("EmployeesApp.Models.Employee", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            EmployeesId = 1,
                            DOB = new DateTime(2024, 2, 19, 23, 12, 55, 930, DateTimeKind.Local).AddTicks(7410),
                            EmployeeName = "ahmed",
                            EmployeeNumber = "1001",
                            GrossSalary = 8000m,
                            HiringDate = new DateTime(2024, 2, 19, 23, 12, 55, 930, DateTimeKind.Local).AddTicks(7466),
                            NetSalary = 7000m
                        });
                });
